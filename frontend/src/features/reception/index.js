    ...
    return (
        <>
            ...
            <div className="mx-lg-4 m-3 pb-4">
                <div>
                    <CommonTable minimumWidth={"900px"} headers={columns} bodyData={patients} renderRow={renderRow} title={"Patients List"} />
                </div>
                {
                    patients.length > 0 &&
            ...
            <div className="mx-lg-4 m-3 pb-4">
                <AppointmentSlider heading={"Upcoming Appointments"} slides={upcomingAppointment} />
            </div>
        </>
    )
}
