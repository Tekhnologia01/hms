  ...
  return (
    <div className="mx-lg-3 m-3">
      ...
      <Row className="g-4 m-0">
        <Col md={4}>
          <div>
            ...
            <div className="border rounded ">
              <div className="ps-3 pt-3 fs-5 fw-semibold">Available Time</div>
              <hr></hr>
              <div className="text-center fw-bold fs-5 pt-3">Doctor Name</div>
              <div className="text-center pt-2 pb-4 fs-6 text-muted">
                Doctor Info in Short
        ...
        <Col md={8}>
          <div>
            <div className="fw-semibold fs-5 mb-2">Biography</div>
            <div className="text-muted ms-1" style={{ fontSize: "1rem" }}>
              {doctorDetails.biography}
            </div>

            <div className="fw-semibold fs-5 mt-5">Education</div>
            <div className="text-muted ms-1" style={{ fontSize: "1rem" }}>
              {doctor?.degree}
            </div>
            ...
            <div className="fw-semibold fs-5 mt-2">Post Degree</div>
            <div className="text-muted ms-1" style={{ fontSize: "1rem" }}>
              {doctor?.post_degree}
            </div>
            <hr />
            ...
            <div className="fw-semibold fs-4 mt-2">Specializations</div>
            <div className="d-flex gap-2 mt-2 flex-wrap">
