...
//         <Modal.Body>
//           <div
//             className="text-center fs-1 p-3 fw-bold"
//             style={{ color: "rgb(25, 123, 136)" }}
//           >
//             Payment Successful!
//           </div>
//           <p className="text-center fw-bold fs-5 pt-lg-2">
//             Thank You! Your Payment of Rs. [Amount here] has been received.
//           </p>
//         </Modal.Body>
...
//         <div className="fw-bold fs-4">Need some Help?</div>
...
//         <div className=" fs-5">
//           Describe your question and specialists will answer you withinn 24
//           hours .
//         </div>

//         <div className="pb-4">
//           <label className="pb-2 pt-4  fw-semibold" style={{fontSize:'1.1rem'}}>Request Subject</label>
//           <SearchDropdown
//             name={"cafeId"}
